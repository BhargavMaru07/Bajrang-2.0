    ...
    <>
      ...
      >
        <button
          ...
          className="fixed bottom-[20px] sm:bottom-[30px] right-[20px] sm:right-[35px] border-none w-14 h-14 cursor-pointer rounded-full flex items-center justify-center bg-btn"
        >
          {showchatBot ? (
            <span className="absolute text-[#fff]">
              <ICONS.CLOSE_CHAT size={30} />
            </span>
          ) : (
            <span className="absolute text-[#fff]">
              <ICONS.MSG size={30} />
        ...
        <div
          className={`chatbot-popup z-[999] fixed overflow-hidden bg-[#fff] sm:w-[420px] rounded-lg shadow sm:bottom-[100px] w-full bottom-0 right-0 sm:right-[60px] h-full sm:h-auto ${
            showchatBot
        ...
        >
          {/* CHAT HEADER */}
          <div className="flex items-center justify-between px-5 py-4 chat-header bg-btn">
            <div className="flex items-center gap-3 header-info">
              <ICONS.CHAT_BOT className="w-8 h-8 p-1 bg-white rounded-lg fill-btn" />
              <h2 className="logo-text text-[#fff] text-[1.1rem]">
          ...
          <div
            ref={chatBodyRef}
            // style={{ height: "calc(90% - 55px)" }}
            className={`chat-body sm:p-[25px] h-[calc(90%-79px)] sm:h-[460px] overflow-y-auto flex flex-col gap-5 mb-[80px] p-3`}
          >
